...
_n_elements = [1000, 5000, 10000, 50000, 100000, 200000, 300000, 400000, 500000, 1000000, 10000000]
_M = [8, 16, 32, 64, 128, 256, 512]
_efConstruction = [8, 16, 32, 64, 128, 256, 512]
# _m_L = []
_n_insertions = [10, 100, 500, 1000, 5000, 10000, 50000]
_efSearch = [8, 16, 32, 64, 128, 256, 512]
_K = [5, 10, 20, 50, 100, 200, 500]
...
for n_elements in _n_elements:
    for M in _M:
        for efConstruction in _efConstruction:
